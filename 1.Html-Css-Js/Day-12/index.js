let c=document.querySelector("title").innerText;
let data;
...
data.forEach(element => {
    ...
    let disconut=document.createElement("p");
    let button=document.createElement("button");
    img.src=element.image_url;
    name.innerText=element.name;
    price.innerText="Price - "+element.price
    disconut.innerText=element.strikedoffprice;
    ...
    div.append(img,name,price,disconut,button);
